<template>
  <div class="page-login">
    <div class="container-fluid">
      <div
        class="page-login__body d-flex flex-row position-relative justify-content-center align-items-center"
      >
        <div class="d-flex justify-content-center align-items-center w-100">
          ...
          >
            ...
            <p class="mt-3 align-self-center">
              ...
              <NuxtLink to="/">Sign in now!</NuxtLink>
            </p>
          </b-form>
        </div>
        <div
          class="d-flex flex-column-reverse justify-content-between align-items-center w-100"
        >
          <div
          ...
          >
            ...
            <rect
              ...
              fill="#3f3d56"
            />
            <circle cx="718.80595" cy="530" r="72" fill="#4ea685" />
            <rect x="812.80595" y="463" width="24" height="24" fill="#4ea685" />
            <rect
              x="842.80595"
              y="463"
              width="24"
            ...
            <rect x="92.80595" y="376" width="46" height="46" fill="#4ea685" />
...
.page-login .container-fluid:before {
  content: '';
  position: fixed;
  z-index: -1;
  top: 0;
  ...
  background-image: linear-gradient(-45deg, #36c2a6 0%, #36c2a6 100%);
